...
- **フルスクリーンTUI**（ratatui）— 5状態表示（Waiting/Running/Updated/Unchanged/Failed）とリアルタイムプログレス
...
└──────────────────────────────────────────────────────────────┘
┌──────────────────────────────────────────────────────────────┐
│ Total: 101 | Done: 50 (Updated: 30 / Unchanged: 18 / Failed: 2) │
└──────────────────────────────────────────────────────────────┘
```
...
全リポジトリの処理完了後、2秒間キー入力を待つ（フッタにヒント表示）。何かキーを押すとブラウズモードに移行して結果を確認できる。何もしなければ自動終了する。
